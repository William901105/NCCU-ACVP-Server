...
from .descriptor import build_mlkem_descriptor, build_mlkem_tr1_descriptor
...
class MlkemAlgorithmModule:
    ...
    def validate_response(
        ...
        *,
        ...
        return validate_mlkem_response(
...
class MlkemTr1AlgorithmModule(MlkemAlgorithmModule):
    """ML-KEM / encapDecap / FIPS203-tr1 (adds the keyFormats capability)."""

    provider_id = "nist-ml-kem-fips203-tr1"
    revision = REVISION_TR1

    def __init__(self) -> None:
        self.descriptor: AlgorithmDescriptor = build_mlkem_tr1_descriptor()
