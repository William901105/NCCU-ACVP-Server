...
# Per-testGroup keyFormat as emitted by NIST GenVal. Functions that do not use a
# decapsulation key (encapsulation, encapsulationKeyCheck, decapsulationKeyCheck)
# carry keyFormat "none"; decapsulation carries "seed" or "expanded".
